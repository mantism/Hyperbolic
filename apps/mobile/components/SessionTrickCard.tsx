...
export default function SessionTrickCard({
  ...
  const [editValue, setEditValue] = useState(trickLog.reps.toString());
  ...
  const handleRepsPress = () => {
    setEditValue(trickLog.reps.toString());
    setIsEditing(true);
  };
          ...
          <View style={styles.stepper}>
            <TouchableOpacity
              ...
              style={[
                ...
                trickLog.reps <= 1 && styles.stepperButtonDisabled,
              ]}
              disabled={trickLog.reps <= 1}
            >
              <Ionicons
                name="remove"
                size={18}
                color={trickLog.reps <= 1 ? "#ccc" : "#666"}
              />
            </TouchableOpacity>
            ...
            {isEditing ? (
              ...
              <TouchableOpacity onPress={handleRepsPress}>
                <Text style={styles.repsText}>{trickLog.reps}</Text>
              </TouchableOpacity>
            )}
