...
/**
 * Base log type that both TrickLog and ComboLog share
 */
...
interface BaseLogsProps<T extends BaseLog> {
  logs: T[];
  loading: boolean;
  showReps?: boolean;
  emptySubtext?: string;
...
export default function BaseLogs<T extends BaseLog>({
  logs,
  loading,
  showReps = true,
  emptySubtext = 'Tap "Add Log" to record with notes and details',
  onAddPress,
}: BaseLogsProps<T>) {
  if (loading) {
    return (
          ...
          {logs.map((log) => (
            <View key={log.id} style={styles.logItem}>
              ...
              <View style={styles.logDetails}>
                {showReps && log.reps !== undefined && log.reps !== null && (
